        ...
        <aside
            ...
            <div class="sidenav-header">
                ...
                <a class="navbar-brand m-0" href=" / " target="_blank">
                    <img src="/plantilla_argon/assets/img/logo-ct-dark.png" class="navbar-brand-img h-100"
                        alt="main_logo">
            ...
            <div class="sidenav-footer mx-3 ">
                <div class="card card-plain shadow-none" id="sidenavCard">
                    <img class="w-50 mx-auto" src="/plantilla_argon/assets/img/illustrations/icon-documentation.svg"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4"
                                    ...
                                    <li class="mb-2">
                                        <a class="dropdown-item border-radius-md" href="javascript:;">
                                            <div class="d-flex py-1">
                                                <div class="my-auto">
                                                    <img src="/plantilla_argon/assets/img/team-2.jpg"
                                    ...
                                    <li class="mb-2">
                                        <a class="dropdown-item border-radius-md" href="javascript:;">
                                            <div class="d-flex py-1">
                                                <div class="my-auto">
                                                    <img src="/plantilla_argon/assets/img/small-logos/logo-spotify.svg"
